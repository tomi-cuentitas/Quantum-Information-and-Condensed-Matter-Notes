...
\begin{align}
       ...
       &= \bigg(u-\frac{i}{2}\bigg) \mathds{1}_{n, \alpha} + i \bm{\mathcal{P}}_{n, a}.
\end{align}
...
Consider two distinct lax operators, say $\bm{\mathcal{L}}_{n, a_1}(u_1)$ and $\bm{\mathcal{L}}_{n, a_2}(u_2)$, acting on two different auxiliary spaces, $\mathds{V}_{a_1}$
and $\mathds{V}_{a_2}$, which are defined to act on the same local quantum state space  $\mathds{V}_{n}$. The product of these two operator is then a triple tensor product in $\mathds{V}_{n} \otimes \mathds{V}_{a_1} \otimes \mathds{V}_{a_2}$. The relation between these two lax operators can then be written as the fundamental commutation relation

\begin{equation}
    \bm{\mathcal{R}}_{a_1, a_2}(u_1-u_2) \bm{\mathcal{L}}_{n, a_1} (u_1) \bm{\mathcal{L}}_{n, a_2} (u_2) = \bm{\mathcal{L}}_{n, a_1} (u_2) \bm{\mathcal{L}}_{n, a_1} (u_1) \bm{\mathcal{R}}_{a_1, a_2}(u_1-u_2),
    \label{fundamental commutation relation}
\end{equation}

where the quantum $\bm{\mathcal{R}}$-matrix relates the permutation and spectral parameters of two auxiliary spaces and is given by 

\begin{equation}
    \bm{\mathcal{R}}_{a_1, a_2}(u_1-u_2) = (u_1-u_2) \mathds{1}_{a_1, a_2} + i \bm{\mathcal{P}}_{a_1, a_2},
\end{equation}

where $\bm{\mathcal{R}}$ acts in $\mathds{V}_{a_1} \otimes \mathds{V}_{a_2}$, which can be rewritten as a $\twobytwo$-matrix in either of the auxiliary spaces 
