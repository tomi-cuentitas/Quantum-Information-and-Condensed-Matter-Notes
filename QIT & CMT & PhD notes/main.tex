...
\mathcal{B}^{\ell = 0} \arrow[d, "f_0"]\arrow[r, "\subset"] 
& \mathcal{B}^{\ell = 1} \arrow[r,"\subset"] \arrow[d, "f_1"] 
& \cdots \arrow[r,"\subset"]\arrow[d,"f_s"] & \mathcal{B}^{\ell = \gamma-1} \arrow[r, "\subseteq"]\arrow[d,"f_{\gamma-1}"] 
& \mathcal{B}^{\ell = \gamma} \arrow[d,"f_\gamma"] \\
\mathcal{V}S^{\ell = 0} \arrow[r, "\subset"] & \mathcal{V}^{\ell = 1} \arrow[r,"\subset"] & \cdots \arrow[r, "\subset"] & \mathcal{V}^{\ell = \gamma-1} \arrow[r, "\subseteq"] & \mathcal{V}^{\ell = \gamma }
\end{tikzcd}
...
\begin{figure}[H]
        \centering
        \includegraphics[scale = .45, left]{figs/Variable Length/avgs_ev_proj_ev_var_lengths_processed=5_items.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = .45, left]{figs/Variable Length/metrics_proj_ev_var_lengths_processed=5_items.png}\caption{Metrics for a variable-length spin chain.}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = .25]{figs/Variable Temp/avgs_ev_proj_ev_var_temps_processed=4_itemsXX.png}
    \caption{Avgs}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = .25]{figs/Variable Temp/metrics_proj_ev_var_temps_processed=4_itemsXX.png}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
